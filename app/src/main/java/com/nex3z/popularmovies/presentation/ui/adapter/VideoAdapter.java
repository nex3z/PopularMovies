...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> {
    ...
    public void setVideoCollection(Collection<VideoModel> videoCollection) {
        validateVideoCollection(videoCollection);
        mVideos = (List<VideoModel>) videoCollection;
        notifyDataSetChanged();
    }

    private void validateVideoCollection(Collection<VideoModel> videoCollection) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tv_video_title) public TextView mTvTitle;
